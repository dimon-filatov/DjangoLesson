...
def index(request):
    ...
    html = f"<h1>Страница приложения Tasks</h1><a href='{projects_list_url}'>Список проектов</a><br><a href='{quality_control_page_url}'>Перейти на страницу багов и предложений</a>"
